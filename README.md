...
The Hook folder contains introductory materials, while the Rubric gives a detailed process on the techinical steps. The Materials directory houses the raw data, relevant articles, and blog posts. The SCRIPTS folder contains the core logic—specifically a Jupyter Notebook for data processing. The OUTPUT folder stores all generated plots and findings.
